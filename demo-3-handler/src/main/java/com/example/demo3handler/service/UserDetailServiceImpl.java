package com.example.demo3handler.service;

import com.example.demo3handler.entity.Role;
import com.example.demo3handler.mapper.UserMapper;
...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        com.example.demo3handler.entity.User user = userMapper.selectUserByName(userName);
        if (user == null) {
